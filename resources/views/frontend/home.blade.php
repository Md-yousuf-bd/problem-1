                                        ...
                                        <div class="mb-3 ">
                                           ...
                                           <div class="d-flex ">
                                            <div class="form-check">
                                                <input class="form-check-input" value="male" name="gender" type="radio" name="flexRadioDefault"
                                            ...
                                            <div class="form-check ms-2">
                                                <input class="form-check-input" value="fmale" name="gender" type="radio" name="flexRadioDefault"
                                            ...
                                            <div class="form-check ms-2">
                                                <input class="form-check-input" value="other" name="gender" type="radio" name="flexRadioDefault"
                                                    id="flexRadioDefault2" checked>
                                                <label class="form-check-label" for="flexRadioDefault2">
                                                    Other
                                                </label>

            ...
            <div class="card">
                <div class="card-body">
                    <div class="card p-2 mt-1">
                        <h3 class="text-primary">Create template
                            <a href="{{ route('template.list') }}"
                                class="btn btn-primary btn-sm text-white  float-end p-2"></i>  List
                            </a>
                        </h3>
                    </div>
                    <hr>
                    <form action="{{ route('template.store') }}" method="POST" class="needs-validation" novalidate
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" name="category_id" id="validationCustom02" required>
